                    ...
                    <div class="page-header bg-app bg-inverse">
                        <section class="container">
                            ...
                            <div class="p-y-lg text-center">
                                <h1 class="display-2">Confira os planos</h1>
                                <p class="text-muted">Adquira já se cadastrando na plataforma.</p>
                            </div>
                            <!-- End Section Content -->
                        </section>
                    </div>
                            ...
                            <div class="row m-y">
                                ...
                                <div class="col-sm-6 col-lg-4">
                                    ...
                                    <a class="card hover-shadow-3 text-center" href="frontend_login_signup.html">
                                        ...
                                        <div class="card-block bg-gray-lighter-o">
                                            <span class="btn btn-default">Cadastrar</span>
                                        </div>
                                    </a>
                                    <!-- End Startup Plan -->
                                </div>
