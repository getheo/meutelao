...
function enviaUsuarioEmail($usuario, $senha)
{
    ...
    try {
        ...
        $mail->Host = "177.85.101.50";  // especifico o endereço do servidor smtp
        $mail->SMTPAuth = true;  // ativo a autenticação SMTP,
        $mail->Username = "contato@meutelao.com.br";  // Usuário SMTP
        $mail->Password = "M39T3l@0";  // Senha do usuário SMTP
